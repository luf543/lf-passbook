...
Authority' certificate and to conver the `.p12` files into `.pem` files.
...
var template = createTemplate("coupon", {
  passTypeIdentifier: "pass.com.tuniu.trainPassbook",
  teamIdentifier:     "MXL",
...
```js
template.fields.passTypeIdentifier = "pass.com.tuniu.trainPassbook";
...
```js
template.keys("pass-book/keys", "secret");
template.loadImagesFrom("pass-book/images");
```
...
pass.loadImagesFrom("pass-book/images");
```
